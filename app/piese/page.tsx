...
type SP = { q?: string; oem?: string; categorie?: string; vehicul?: string; stare?: string; sort?: string };
...
export default async function Piese({ searchParams }: { searchParams: SP }) {
  ...
  return (
    <div className="mx-auto max-w-6xl px-4 py-8">
      ...
      <h1 className="font-disp font-black uppercase text-3xl mt-2 mb-6">{titlu}</h1>
      <div className="grid lg:grid-cols-[220px,1fr] gap-6">
        <aside className="card p-4 h-fit text-sm">
          <b className="font-disp uppercase tracking-widest text-[12px] text-mut">Categorii</b>
          ...
          <b className="font-disp uppercase tracking-widest text-[12px] text-mut block mt-5">Stare piesă</b>
          <ul className="mt-2 space-y-1">
