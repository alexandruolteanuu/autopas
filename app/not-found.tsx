...
export default function NotFound() {
  return (
    <div className="mx-auto max-w-2xl px-4 py-24 text-center">
      <div className="font-disp font-black text-[90px] leading-none text-line">404</div>
      <h1 className="font-disp font-black uppercase text-3xl mt-2">Pagina asta a fost dezmembrată.</h1>
