...
const FAQ = [
  ...
  ["Cât durează livrarea și cât costă?","1–3 zile lucrătoare prin FAN Courier, în toată România. Costul livrării depinde de greutatea și dimensiunile piesei, așa că nu are un tarif fix: după ce plasezi comanda, calculăm transportul și te sunăm cu totalul exact — piese plus transport. Nu expediem nimic până nu ești de acord cu suma, iar dacă nu îți convine poți anula fără niciun cost."],
  ...
  ["Cum plătesc?","Ramburs la livrare — plătești curierului când primești piesa, după ce ai verificat coletul. Nu îți cerem date de card și nu ceri nimic în avans."],
