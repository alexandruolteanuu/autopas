...
const FAQ = [
  ...
  ["Cât durează livrarea și cât costă?","1–3 zile lucrătoare prin FAN Courier, în toată România. Costul livrării depinde de greutatea și dimensiunile piesei și îl vezi calculat în coș, înainte să plasezi comanda. Piesele voluminoase se livrează paletizat, cu tarif comunicat înainte de expediere."],
