...
const FAQ = [
  ...
  ["Cum verific dacă piesa se potrivește pe mașina mea?","Fiecare piesă are lista de compatibilitate. Dacă nu ești sigur, trimite-ne seria de șasiu (VIN) pe WhatsApp — verificăm noi, gratuit."],
  ["Cât durează livrarea și cât costă?","1–3 zile lucrătoare prin FAN Courier, în toată România. Costul livrării depinde de greutatea și dimensiunile piesei, așa că nu are un tarif fix: după ce plasezi comanda, calculăm transportul și te sunăm cu totalul exact — piese plus transport. Transportul îl plătești direct curierului FAN, la livrare. Nu expediem nimic până nu ești de acord cu suma, iar dacă nu îți convine poți anula fără niciun cost."],
  ["Pot returna piesa?","Da, te poți retrage din contract în 14 zile calendaristice de la primire, fără să motivezi decizia (OUG 34/2014), folosind Formularul de retur din subsol. Îți rambursăm contravaloarea produselor în cel mult 14 zile; costul direct al returnării îl suporți tu. Atenție: retragerea în 14 zile („m-am răzgândit”) e diferită de garanția de 90 de zile („piesa are un defect”)."],
  ["Cum plătesc?","Ramburs la livrare — plătești curierului când primești piesa. Nu îți cerem date de card și nu ceri nimic în avans."],
...
export default function Faq() {
  return (
    <div className="mx-auto max-w-3xl px-4 py-8">
      ...
      <h1 className="t-sectiune mt-2 mb-6">Întrebări frecvente</h1>
