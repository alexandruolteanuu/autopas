...
export default function CookieBanner() {
  ...
  return (
    <div className="fixed bottom-0 inset-x-0 z-50 bg-headerBg text-headerText shadow-2xl border-t border-white/10">
      <div className="mx-auto max-w-6xl px-4 py-4 flex flex-col md:flex-row md:items-center gap-3">
        <p className="text-sm text-headerText/85 flex-1">
        ...
        <div className="flex gap-2">
          ...
          <button onClick={() => alege("toate")} className="rounded-lg bg-accent text-accentText px-4 py-2 text-sm font-bold">Accept toate</button>
        </div>
      </div>
    </div>
  );
