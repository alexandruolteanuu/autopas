  ...
  return (
    <footer className="bg-ink text-white mt-16">
      <div className="mx-auto max-w-6xl px-4 py-10 grid gap-8 sm:grid-cols-2 lg:grid-cols-4 text-sm">
        <div>
          <span className="block font-disp font-black text-[24px]">AUTOPAS</span>
        ...
        <div>
          <h4 className="font-disp font-bold uppercase tracking-widest text-[12px] text-white/50 mb-3">Pagini principale</h4>
        ...
        <div>
          <h4 className="font-disp font-bold uppercase tracking-widest text-[12px] text-white/50 mb-3">Informații</h4>
          <ul className="space-y-1.5 text-white/80">
        ...
        <div>
          <h4 className="font-disp font-bold uppercase tracking-widest text-[12px] text-white/50 mb-3">Retur și garanție</h4>
          <ul className="space-y-1.5 text-white/80">
          ...
          {/* Bannerele obligatorii — stil vizibil (pe site-ul live se leagă spre paginile oficiale) */}
          <div className="mt-4 space-y-2">
            <a href="https://anpc.ro/ce-este-sal/" target="_blank" rel="noopener noreferrer"
              className="block rounded-md bg-[#1B3E7A] px-3 py-2 text-[11px] font-bold leading-tight border border-white/20">
              ANPC — SOLUȚIONAREA<br/>ALTERNATIVĂ A LITIGIILOR <span className="text-[#FFC81A]">→ detalii</span></a>
            <a href="https://ec.europa.eu/consumers/odr" target="_blank" rel="noopener noreferrer"
              className="block rounded-md bg-[#123463] px-3 py-2 text-[11px] font-bold leading-tight border border-white/20">
              SOL — SOLUȚIONAREA ONLINE<br/>A LITIGIILOR <span className="text-[#FFC81A]">→ detalii</span></a>
          </div>
        </div>
      </div>
