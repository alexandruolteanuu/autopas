    ...
    <header className="bg-ink text-white sticky top-0 z-40">
      <div className="bg-black/25 text-[12px]">
        <div className="mx-auto max-w-6xl px-4 py-1.5 flex justify-between gap-3">
          <span>☎ 0740 123 456 · L–V 08–17, S 09–13</span>
      ...
      <div className="mx-auto max-w-6xl px-4 py-3 flex items-center gap-4">
        ...
        <Link href="/" className="leading-none shrink-0">
          <span className="block font-disp font-black text-[26px] tracking-wide">AUTOPAS</span>
        ...
        <Link href="/cos" className="relative ml-auto md:ml-0 font-disp font-semibold text-sm uppercase tracking-wide">
          Coșul meu
          {items.length > 0 && (
      ...
      <nav className={`bg-steel/60 ${open ? "block" : "hidden"} md:block`}>
        <div className="mx-auto max-w-6xl px-4 flex flex-col md:flex-row gap-x-1 text-[13px] font-disp font-semibold uppercase tracking-wider">
          {NAV.map((n) => (
